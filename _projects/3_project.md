...
To create robust data with various bacgrounds, I used the augmentation method using instance segmentation to improve the performance.

<div class="row justify-content-sm-center">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/background/Solo_before_removing.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
    <div class="col-sm-7 mt-3 mt-md-0">
...
<div class="caption">
    Figure 5. The left image(before the code is applied) is augmented to right image(after the code is applied)
</div>  
